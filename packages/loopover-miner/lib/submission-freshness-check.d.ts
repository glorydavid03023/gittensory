export declare const SUBMISSION_FRESHNESS_ABORT_EVENT: "submission_freshness_abort";
...
export type SubmissionFreshnessResult = {
    fresh: true;
} | {
    fresh: false;
 ...
 */
export declare function checkSubmissionFreshness(candidate: SubmissionFreshnessCandidate, deps: SubmissionFreshnessDeps, options?: SubmissionFreshnessRetryOptions): Promise<SubmissionFreshnessResult>;
