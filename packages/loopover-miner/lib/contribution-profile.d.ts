...
export type ContributionSignalConfidence = "explicit" | "inferred" | "absent" | "unknown";
...
export type ContributionSignalSource = "labels" | "contributing_md" | "pr_template" | "agent_docs";
...
/** Bumped when the field set/semantics change, so a cached profile from an older extractor is detectable. */
export declare const CONTRIBUTION_PROFILE_SCHEMA_VERSION: 1;
...
export declare const CONTRIBUTION_SIGNAL_CONFIDENCE_LEVELS: readonly ["explicit", "inferred", "absent", "unknown"];
/** The signal sources a rule can be derived from (#6794 found the primary source differs per repo). */
export declare const CONTRIBUTION_SIGNAL_SOURCES: readonly ["labels", "contributing_md", "pr_template", "agent_docs"];
/** Default cache TTL: 7 days. Labels/docs change slowly; a week bounds staleness without re-fetching per run. */
export declare const CONTRIBUTION_PROFILE_CACHE_TTL_MS: number;
/** The local SQLite store table the cache (#6797) will use, named here so the schema owns it. */
export declare const CONTRIBUTION_PROFILE_STORE_TABLE: "miner_contribution_profile";
/**
 ...
 */
export declare function emptyContributionProfile(repoFullName: string, generatedAt: string): ContributionProfile;
/**
 ...
 */
export declare function weakestConfidence(confidences: readonly ContributionSignalConfidence[]): ContributionSignalConfidence;
