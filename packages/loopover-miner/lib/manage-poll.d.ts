 ...
 */
export declare function recordManagePollSnapshot(input: ManagePollInput, options?: {
    ...
    lastPolledAt?: string;
} & PollCheckRunsOptions): Promise<ManagePollRecordResult>;
export declare function runManagePoll(args?: string[], options?: {
    ...
    githubToken?: string;
    lastPolledAt?: string;
} & PollCheckRunsOptions): Promise<number>;
